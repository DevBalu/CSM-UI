	...
	<body>
		...
		<div id="oneSec">
			...
			<div id="auth_step1" class="container">
				<div id="curent_steps">
					<div class="steps item_center"><div class="item_center paint_step">1</div></div>
				...
				<div id="captcha"><!-- section captcha -->
					...
					<div class="row"><!-- cap_field -->
						<div class="capt_field col s4 m4 l4 offset-s4 offset-m4 offset-l4">
							<div class="row">
								<div>
<!-- ---------------------------------------------------------------- -->
									<form method="post" action="" class="column" id="form1">
											...
											<div class="validationDiv">
												<div class="sub"><input name="CaptchaCode" type="text" id="CaptchaCode" placeholder="introduce characters" /></div>
												<input type="submit" name="ValidateCaptchaButton" value="Validate" id="ValidateCaptchaButton" class="btn"/>
